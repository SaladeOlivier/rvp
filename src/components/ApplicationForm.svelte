...
<div class="application-form">
  ...
  <!-- <form on:submit|preventDefault={generateDocument}>
    ...
    <div class="form-actions">
      ...
      <button type="button" class="clear-btn" on:click={clearForm}>🗑️ Clear Form</button>
    </div>

    <div class="form-notice">
      <p>
        ⚠️ <strong>Important:</strong> This generated document is for reference only. Always use
